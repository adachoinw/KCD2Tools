...
- Added a detached free cam (default key F): fly freely with WASD + Space/Ctrl and mouse look, independent of your character, who stays put while it is active
- Added a freeze hotkey (FreeCamFreezeKey, unbound by default) that holds the free cam's exact position and angle, ignoring mouse and keyboard, for steady screenshots
